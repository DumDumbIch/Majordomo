package ru.dumdumbich.base.ui.view
...
abstract class BaseFragment<VB : ViewBinding>(
    ...
    override fun onCreateView(
        ...
        logger.toConsole("onCreateView() called with: inflater = $inflater, container = $container, savedInstanceState = $savedInstanceState")
        _ui = bindingInflater.invoke(layoutInflater)
        return ui.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        logger.toConsole("onViewCreated() called with: view = $view, savedInstanceState = $savedInstanceState")
